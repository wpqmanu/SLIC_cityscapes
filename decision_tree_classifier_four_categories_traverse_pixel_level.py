...
def predict(index,random_list,superpixel_data,gt_files,folder_files,final_selected_rule_set,original_image_files,result_location,is_test_lower_bound,is_use_neighbor,traverse_category_list):
...
if __name__ == '__main__':
    ...
    Parallel(n_jobs=num_cores)(
        delayed(predict)(i, random_list,superpixel_data,gt_files,folder_files,final_selected_rule_set,original_image_files,result_location,is_test_lower_bound,is_use_neighbor,traverse_category_list) for i in
        range_i)
