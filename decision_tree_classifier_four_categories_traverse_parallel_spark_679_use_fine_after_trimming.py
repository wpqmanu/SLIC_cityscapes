...
def spark_processing(rule_index):
    ...
    all_possible_rule_list.append(([255,	255,	255,	9],9))
    ...
    all_possible_rule_list.append(([7,	7,	255,	255],255))
    ...
    all_possible_rule_list.append(([9,	9,	255,	255],255))
    all_possible_rule_list.append(([9,	9,	255,	9],255))



    current_rule=all_possible_rule_list[rule_index]
    result_location = os.path.join('/mnt/scratch/panqu/SLIC/prediction_result/four_layers_rule_traverse_category_set_679_use_fine_after_trimming/', dataset,
