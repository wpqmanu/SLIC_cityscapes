...
def spark_processing(rule_index):
    ...
    for index,possible_rule in enumerate(all_possible_rule_list):
        ...
        if possible_rule[0][0]==14 or possible_rule[0][1]==14 or possible_rule[0][1]==15 or \
           possible_rule[0][1]==16 or possible_rule[0][0]==possible_rule[1]:
    ...
    result_location = os.path.join('/mnt/scratch/panqu/SLIC/prediction_result/four_layers_rule_traverse_category_set_141516_use_fine_train/', dataset,
