...
def spark_processing(rule_index):
    ...
    superpixel_result_folder='/mnt/scratch/panqu/SLIC/server_combine_all_merged_results_'+dataset+'_use_fine_train/'
    ...
    for index,possible_rule in enumerate(all_possible_rule_list):
        ...
        if possible_rule[0][1]==3 or \
           possible_rule[0][1]==4 or \
           possible_rule[0][2]==4 or \
           possible_rule[0][2]==5 or \
           possible_rule[0][3]==5 or \
           possible_rule[0][0]==possible_rule[1]:
    ...
    result_location = os.path.join('/mnt/scratch/panqu/SLIC/prediction_result/four_layers_rule_traverse_category_set_345_use_fine_train/', dataset,
