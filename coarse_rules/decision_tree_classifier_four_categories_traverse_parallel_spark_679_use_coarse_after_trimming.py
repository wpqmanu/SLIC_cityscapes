...
def spark_processing(rule_index):
    ...
    superpixel_result_folder='/mnt/scratch/panqu/SLIC/server_combine_all_merged_results_'+dataset+'_use_coarse_test/'
    ...
    result_location = os.path.join('/mnt/scratch/panqu/SLIC/prediction_result/four_layers_rule_traverse_category_set_679_use_coarse_after_trimming/', dataset,
