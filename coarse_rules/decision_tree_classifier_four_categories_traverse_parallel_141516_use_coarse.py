...
def parallel_processing(rule_index, all_possible_rule_list, random_list,superpixel_data,gt_files,folder_files,original_image_files,is_test_lower_bound,is_use_neighbor,traverse_category_list):
    ...
    result_location = os.path.join('/mnt/scratch/panqu/SLIC/prediction_result/four_layers_rule_traverse_category_set_141516_use_coarse_train/', dataset,
    ...
    for index in random_list:
        ...
        for predicted_index,superpixel_index in enumerate(superpixel_index_set):
            ...
            if current_categorical_labels[2]==16:
...
if __name__ == '__main__':
    ...
    for index,possible_rule in enumerate(all_possible_rule_list):
        # truck (label 14) and bus (label 15) and train (label 16)
        if possible_rule[0][0]==14 or possible_rule[0][1]==14 or possible_rule[0][1]==15 or \
           possible_rule[0][1]==16 or possible_rule[0][2]==16 or possible_rule[0][0]==possible_rule[1]:
    ...
    len_rules=len(all_possible_rule_list) #219 rules in total
