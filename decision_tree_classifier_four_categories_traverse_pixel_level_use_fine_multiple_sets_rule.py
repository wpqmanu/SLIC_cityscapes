...
if __name__ == '__main__':
    ...
    # prediction
    if not use_full_validation_test:
        result_location = os.path.join('/mnt/scratch/panqu/SLIC/prediction_result/four_layers_rule_traverse_use_fine/', dataset,'all_selected_rules_pixel_level_'+current_set[0]+current_set[1]+current_set[2])
    else:
        result_location = os.path.join('/mnt/scratch/panqu/SLIC/prediction_result/four_layers_rule_traverse_use_fine/', dataset+'_full_modified','all_selected_rules_pixel_level_'+current_set[0]+current_set[1]+current_set[2])
