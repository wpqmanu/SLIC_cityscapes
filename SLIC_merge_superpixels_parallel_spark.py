...
def processing(index,superpixel_data,superpixel_images,place_to_save):
    print index
...
def spark_processing(i):
    ...
    processing(i,superpixel_data,superpixel_images,place_to_save)
...
num_cores=80
conf = SparkConf()
conf.setAppName("semantic_segmentation_superpixel_merge").setMaster("spark://192.168.1.132:7077")
