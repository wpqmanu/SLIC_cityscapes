...
def predict(random_list,superpixel_data,gt_files,folder_files,current_rule,original_image_files,result_location,is_test_lower_bound,is_use_neighbor,traverse_category_list):
    ...
    for index in random_list:
        ...
        for predicted_index,superpixel_index in enumerate(superpixel_index_set):
            ...
            if current_categorical_labels[3]==5:
                current_categorical_labels[3]=255
            if current_categorical_labels[4]==3 or current_categorical_labels[4]==5:
...
def spark_processing(rule_index):
    ...
    traverse_category_list=[3,4,5,255] # you only want to explore several categories (255 means all others)
    ...
    for index,possible_rule in enumerate(all_possible_rule_list):
        ...
        if possible_rule[0][0]==3 or possible_rule[0][1]==3 or possible_rule[0][4]==3 or \
           possible_rule[0][1]==4 or possible_rule[0][2]==4 or possible_rule[0][2]==5 or \
           possible_rule[0][3]==5 or possible_rule[0][4]==5:
    ...
    result_location = os.path.join('/mnt/scratch/panqu/SLIC/prediction_result/four_layers_rule_traverse_category_set_345_use_coarse_train/', dataset,
